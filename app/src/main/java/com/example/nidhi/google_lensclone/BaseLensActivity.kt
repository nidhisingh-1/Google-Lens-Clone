...
import com.example.nidhi.google_lensclone.CameraActivity.Companion.CAMERA_PERM_CODE
...
abstract class BaseLensActivity : AppCompatActivity() {
    ...
    private fun checkCameraPermissions() {
        ...
        else requestPermissions(arrayOf(Manifest.permission.CAMERA), CAMERA_PERM_CODE)
    }
